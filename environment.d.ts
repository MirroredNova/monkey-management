declare namespace NodeJS {
  interface ProcessEnv {
    ...
    NEXT_PUBLIC_CLOUDINARY_PROJECT_COVER_IMAGE_TRANSFORMATION: string;
    NEXT_PUBLIC_CLOUDINARY_PROJECT_BANNER_IMAGE_TRANSFORMATION: string;
    NEXT_PUBLIC_CLOUDINARY_BLOGS_CONTENT_IMAGE_TRANSFORMATION: string;
